# -*- org-confirm-babel-evaluate: nil; after-save-hook: (lambda nil (async-shell-command "make")); -*-
...
this before trying to enable this [[https://github.com/kmonad/kmonad/blob/master/doc/faq.md][guide]] service though.
